...
console.log(osoba1.__proto__ === Osoba.prototype); // true
console.log(osoba2.__proto__ === Osoba.prototype); // true
...
const osoba3 = new Osoba(`Tomek`, 35);
osoba3.getWiek();//"mam 35 lat"
osoba3.hasOwnProperty(`getWiek`);//true
typeof Osoba;//"function"
osoba3.getWiek = function() {
    return `nowa implementacja`;
}
osoba3.getWiek(); //"nowa implemantacja"

//nowa klasa pracownik
class Pracownik extends Osoba {
    constructor(imie, wiek, wynagrodzenie) {
        super(imie, wiek);
...
const pracownik = new Pracownik(`Jan`, 35, 5000);
